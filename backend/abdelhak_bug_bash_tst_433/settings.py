"""
Django settings for abdelhak_bug_bash_tst_433 project.
...
ROOT_URLCONF = 'abdelhak_bug_bash_tst_433.urls'
...
WSGI_APPLICATION = 'abdelhak_bug_bash_tst_433.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "abdelhak_bug_bash_tst_433 API",
    "DESCRIPTION": "API documentation for abdelhak_bug_bash_tst_433 App",
    "VERSION": "v1",
}
